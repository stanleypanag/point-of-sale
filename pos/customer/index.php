            ...
            <div class="row justify-content-center">
                <div class="col-lg-5 col-md-7">
                    <div class="card bg-secondary shadow border-0">
                        <div class="card-body px-lg-5 py-lg-5" style="background-color:#6D2932;">
                            <form method="post" role="form">
                                ...
                                <div class="form-group">
                                    <div class="text-left">
                                        <button type="submit" name="login" class="btn btn-primary my-4" style="background-color: #E6A4B4; border: none;">Log In</button>
                                        <a href="create_account.php" class=" btn btn-success pull-right" style="background-color: #E6A4B4; border: none;">Create Account</a>
                                    </div>
                                </div>
                            </form>
